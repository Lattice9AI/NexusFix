...
We built [NexusFIX](https://github.com/StratCraftsAI/NexusFIX) to fix that.
...
*Built by [StratCraftsAI](https://github.com/StratCraftsAI). For questions or collaboration: nonagonal.portal@gmail.com*
